...
export default function Header() {
  return (
    <>
        <div className="bg-purple-700 px-8">
            <div className="h-14 md:h-11 container mx-auto flex items-center justify-center sm:justify-between">
                ...
                <nav className=" gap-x-8  hidden sm:flex text-sm font-semibold">
                    <a href="#" className="flex items-center gap-x-2  text-white text-opacity-80 hover:text-opacity-100 transition-colors">
                        <BiGlobe size={18}/>
                        Türkçe(TR)
                    </a>
                    <a href="#" className="flex items-center gap-x-2 text-white text-opacity-80 hover:text-opacity-100 transition-colors">
            ...
            <button className="flex bg-white h-10 w-full items-center px-3 sm:mx-0 md:mx-0 justify-between">
